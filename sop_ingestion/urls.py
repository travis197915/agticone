...
from .rule_change_views import (
    PendingRuleProposalsView,
    RuleChangeSetApproveView,
    RuleChangeSetDetailView,
    RuleChangeSetListView,
    RuleChangeSetRejectView,
    RuleProposeView,
)
...
urlpatterns = [
    ...
    path("rules/pending/",
         PendingRuleProposalsView.as_view(),
         name="rule-proposals-pending"),
    path("rules/pending",
         PendingRuleProposalsView.as_view(),
         name=_slashless("rule-proposals-pending")),
    path("rules/<int:decision_id>/propose/",
         RuleProposeView.as_view(),
         name="rule-propose"),
    path("rules/<int:decision_id>/propose",
         RuleProposeView.as_view(),
         name=_slashless("rule-propose")),
    path("rule-changesets/",
         RuleChangeSetListView.as_view(),
         name="rule-changeset-list"),
    path("rule-changesets",
         RuleChangeSetListView.as_view(),
         name=_slashless("rule-changeset-list")),
    path("rule-changesets/<int:changeset_id>/",
         RuleChangeSetDetailView.as_view(),
         name="rule-changeset-detail"),
    path("rule-changesets/<int:changeset_id>",
         RuleChangeSetDetailView.as_view(),
         name=_slashless("rule-changeset-detail")),
    path("rule-changesets/<int:changeset_id>/approve/",
         RuleChangeSetApproveView.as_view(),
         name="rule-changeset-approve"),
    path("rule-changesets/<int:changeset_id>/approve",
         RuleChangeSetApproveView.as_view(),
         name=_slashless("rule-changeset-approve")),
    path("rule-changesets/<int:changeset_id>/reject/",
         RuleChangeSetRejectView.as_view(),
         name="rule-changeset-reject"),
    path("rule-changesets/<int:changeset_id>/reject",
         RuleChangeSetRejectView.as_view(),
         name=_slashless("rule-changeset-reject")),
