...
The editable installs let you edit agents under `uhc-sop-ingestion/src/` and have Django pick up changes immediately.
...
This applies migrations for both `builder` and `sop_ingestion`. Idempotent — re-run any time models change.
